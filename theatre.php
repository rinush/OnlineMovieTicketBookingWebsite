...
<td><div class="btn-group">
<form action="" method="post">
<input type="text" name="btn_f" style="display:none;" id="txt2">
<input type="submit" id="btn2" class="button" value="11:00 AM" onclick="document.getElementById('txt2').value=document.getElementById('btn2').value;">
</form></div></td>
<td><div class="btn-group">
<form action="" method="post">
<input type="text" name="btn_f" style="display:none;" id="txt3">
<input type="submit" id="btn3" class="button" value="1:40 PM" onclick="document.getElementById('txt3').value=document.getElementById('btn3').value;">
</form></div></td>
<td><div class="btn-group">
<form action="" method="post">
<input type="text" name="btn_f" style="display:none;" id="txt4">
<input type="submit" id="btn4" class="button" value="3:00 PM" onclick="document.getElementById('txt4').value=document.getElementById('btn4').value;">
</form></div></td>
<td><div class="btn-group">
